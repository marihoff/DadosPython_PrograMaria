##O que é um banco de dados: diferença de bancos relacionais e não relacionais

##Bancos de dados relacionais: organizam os dados em tabelas com linhas e colunas, onde cada linha representa um registro e cada coluna representa um campo. Ex: MySQL, PostgreSQL, Oracle
##Bancos de dados não relacionais: organizam os dados de forma diferente, como documentos, grafos ou chave-valor. Ex: MongoDB, Cassandra, Redis
